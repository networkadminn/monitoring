...
<head>
  ...
  <title>WebSites Monitor — Dashboard</title>
  ...
  <main class="main">
    <div class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <button class="btn btn-danger" id="btn-bulk-delete" style="display:none">Delete Selected (<span id="bulk-count">0</span>)</button>
    ...
    <div class="table-panel">
      ...
      <table id="sites-table">
        <thead>
          <tr>
            <th><input type="checkbox" id="select-all-sites" title="Select all"></th>
            <th>Name</th>
            <th>URL</th>
            <th>Status</th>
            <th>Response</th>
